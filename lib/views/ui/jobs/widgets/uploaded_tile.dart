                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ReusableText(text: '${job.salary} ', style: appstyle(12.sp, Color(kDark.value), FontWeight.normal)),
                              ReusableText(text: 'per ${job.period}', style: appstyle(12.sp, Color(kDarkGrey.value), FontWeight.normal)),
                            ],
                          ),
                        ],
                      ),
